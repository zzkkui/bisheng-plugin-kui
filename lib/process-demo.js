...
module.exports = function (_ref) {
  var markdownData = _ref.markdownData,
      ...
      OUTPUT = _ref$OUTPUT === void 0 ? '_site' : _ref$OUTPUT,
      _ref$PUBLIC_PATH = _ref.PUBLIC_PATH,
      PUBLIC_PATH = _ref$PUBLIC_PATH === void 0 ? '/' : _ref$PUBLIC_PATH;
  ...
  if (meta.iframe) {
    ...
    fs.writeFile(path.join(process.cwd(), OUTPUT, fileName), html, function () {});
